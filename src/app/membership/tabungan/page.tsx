  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-700 max-w-[1400px] mb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
        <div>
          <h1 className="text-4xl font-black text-slate-900 tracking-tight">Tabungan</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-8 rounded-[28px] border border-slate-50 shadow-sm flex flex-col justify-between h-[180px] relative overflow-hidden group">
          ...
          <TrendingUp size={64} className="absolute -right-4 -bottom-4 text-indigo-50/50 group-hover:scale-110 transition-transform -rotate-12" />
        </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-slate-50">
                ...
                <th className="px-8 py-6 text-[10px] font-black text-slate-400 uppercase tracking-widest text-center whitespace-nowrap">Sub Kategori</th>
            ...
            <tbody>
              ...
              <tr className="group hover:bg-slate-50/50 transition-colors">
                ...
                <td className="px-8 py-6 whitespace-nowrap font-bold text-slate-900 text-sm">Setoran Dana Darurat</td>
                ...
                <td className="px-8 py-6 whitespace-nowrap font-bold text-slate-600 text-sm">Dana Darurat</td>
                <td className="px-8 py-6 whitespace-nowrap">
